...
struct MainViewModel {
    ...
    init(model: MainModel = MainModel()) {
        let blogReulst = searchBarViewModel.shouldLoadResult
            .flatMapLatest(model.searchBlog)
            .share()
        
        let blogValue = blogReulst
            .compactMap(model.getBlogValue)
        
        let blogError = blogReulst
        ...
        let alertSheetForSorting = blogListViewModel.filterViewMdoel.sortButtonTapped
